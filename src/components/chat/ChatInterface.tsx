    ...
    <div className="flex flex-col h-full bg-gray-900/20 rounded-lg border border-primary/10 overflow-hidden">
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            <EmetAvatar size="lg" />
            <h3 className="text-lg font-semibold text-white mt-4">Welcome to EMET</h3>
            <p className="text-gray-400 text-sm mt-2 max-w-xs">
              Ask about water, energy, food, housing, finance, legal topics, or history. EMET separates source-backed evidence from interpretation and uncertainty.
            </p>
          </div>
        ) : (
      ...
      <div className="border-t border-primary/10 p-4 space-y-3">
        ...
        <p className="text-xs text-gray-500 text-center">
          AI can make mistakes. Verify important claims against the cited source evidence before acting.
        </p>
      </div>
    </div>
  );
